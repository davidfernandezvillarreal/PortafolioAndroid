...
public class Wifi extends AppCompatActivity implements RedesWifi.OnFragmentInteractionListener,
        DescripcionWifi.OnFragmentInteractionListener, Grafica.OnFragmentInteractionListener,
        Pruebas.OnFragmentInteractionListener, HistoricosWifi.OnFragmentInteractionListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            Fragment fragment;
            if (position==0) {
                fragment = new RedesWifi();
                return fragment;
            } else if (position==1) {
                fragment = new DescripcionWifi();
                return fragment;
            } else if (position==2) {
                fragment = new Grafica();
                return fragment;
            } else if (position==3) {
                fragment = new Pruebas();
                return fragment;
            } else if (position==4) {
                fragment = new HistoricosWifi();
                return fragment;
            } else if (position==5) {
